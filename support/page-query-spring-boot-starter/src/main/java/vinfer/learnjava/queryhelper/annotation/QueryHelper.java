package vinfer.learnjava.queryhelper.annotation;
...
public @interface QueryHelper {
     ...
     * 但是用户可以通过定义具体的拦截处理器{@link InterceptionPostProcessor}
     * 来继续实现自定义的拦截逻辑
     ...
     * 查询拦截器{@link QueryHelper}只在MODIFY_SQL模式下生效或工作
     * 而结果拦截器{@link ResultInterceptor} 只在MODIFY_RESULT模式下生效或工作
